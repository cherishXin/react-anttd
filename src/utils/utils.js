...
// 设置网页标签
export const setWebPageLabel = function (SystemConfig) {
    const configName = window._mall ? "Mall" : "V3";
    const favIcon = Object.getValue(SystemConfig, configName + ".Components.WebPageLabel.favIcon.imgPath", null);
    const title = Object.getValue(SystemConfig, configName + ".Components.WebPageLabel.title.text", null);
